...
return array(
	...
	'filter:boolean_values'  => 'You specify the value is not one of the two permissible (%2$s, %3$s) for field - %1$s.',
	'filter:length'          => 'You specify a value less than %2$s or more than %3$s characters for the field - %1$s.',
	'filter:length_equal'    => 'You have specified a value whose length is not equal to %2$s characters for the field - %1$s.',
	'filter:length_min'      => 'You specify a value of less than %2$s characters for the field - %1$s.',
	'filter:length_max'      => 'You specify a value of more than %2$s characters for the field - %1$s.',
	'filter:invalid_email'   => 'You have specify incorrect E-Mail in the field - %s.',
