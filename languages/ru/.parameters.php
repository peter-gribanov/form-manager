...
return array(
	...
	'filter-int'             => 'Вы указали не целое число в поле - %s.',
	'filter-float'           => 'Вы указали не число с плавающей запятой в поле - %s.',
	'filter-bool'            => 'Указанное Вами значение не является одним из двух допустимых%2$s для поля - %1$s.',
	...
	'filter-kcaptcha'        => 'Вы указали некорректный код подтверждения в поле - %s.',
