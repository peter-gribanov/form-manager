 ...
 */
class FormManager_Form extends FormManager_Element implements FormManager_Collection_Interface {
...
//		$this->inputs = & $GLOBALS[$method];
	 ...
	 *
	 * @throws FormManager_Exceptions_Form
	 * 
	 * @param string $method
	 * 
	 * @return FormManager_Form
	...
	public function setMethod($method) {
		...
		if ($method != 'POST' && $method != 'GET') {
			throw new FormManager_Exceptions_Form('Form method must be POST or GET');
		}
